...
public class TaskRecyclerViewAdapterAllTask extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTaskTouchHelperAdapter {
    Context context;
    List<Task> tasks;
    Project project;
    Realm realm;

    public TaskRecyclerViewAdapterAllTask(Context context, List<Task> tasks, Project project, Realm realm) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TaskViewHolderAllTask(LayoutInflater.from(context).inflate(R.layout.item_task_recyclerview_1, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final TaskViewHolderAllTask vh = (TaskViewHolderAllTask) holder;
    ...
    public void onItemDismiss(RecyclerView.ViewHolder viewHolder) {
        ...
        snackbar.setAction("UNDO", new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                project.getTasks().add(deletedTask);
                realm.commitTransaction();
