...
public class TaskActivityCopy extends AppCompatActivity
    ...
    private void initProject()
    {
        ...
        project.setColor(Color.MAGENTA);
        project.setWorkspace(realm.where(Workspace.class).findFirst());
        realm.beginTransaction();
        realm.copyToRealm(project);
        realm.commitTransaction();
                ...
                .setNegativeButton("Add task",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (project == null)
                                    projects.get(0).getTasks().add(taskModel);
                                else
