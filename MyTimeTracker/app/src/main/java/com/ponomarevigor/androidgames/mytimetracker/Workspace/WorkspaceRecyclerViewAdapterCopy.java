...
public class WorkspaceRecyclerViewAdapterCopy extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<Workspace> workspaces;
    Realm realm;

    public WorkspaceRecyclerViewAdapterCopy(Context context, List<Workspace> workspaces, Realm realm) {
