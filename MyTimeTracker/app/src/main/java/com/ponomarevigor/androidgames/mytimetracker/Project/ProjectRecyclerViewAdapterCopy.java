...
public class ProjectRecyclerViewAdapterCopy extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<Project> projects;
    Workspace workspace;
    Realm realm;

    public ProjectRecyclerViewAdapterCopy(Context context, List<Project> projects, Workspace workspace, Realm realm) {
